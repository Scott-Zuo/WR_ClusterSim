...
step_size <- 60
re_count <- 10
#setwd("/Users/sizhezuo/Desktop/YCASResearch/WR_Cluster/Expanded_quad_Imb_MSOR/results/results_0227")
...
png(filename = "fig_quadImbMSOR_Var_WD.png", units = "in",
    width = 6, height = 4, res = 300)
var_plot_WD
dev.off()

png(filename = "fig_quadImbMSOR_Var_WR.png", units = "in",
    width = 6, height = 4, res = 300)
var_plot_WR
dev.off()
...
png(filename = "fig_quadImbMSOR_MSE_WD.png", units = "in",
    width = 6, height = 4, res = 300)
mse_plot_WD
dev.off()

png(filename = "fig_quadImbMSOR_MSE_WR.png", units = "in",
    width = 6, height = 4, res = 300)
mse_plot_WR
dev.off()
...
png(filename = "fig_quadImbMSOR_Bias_WD.png", units = "in",
    width = 6, height = 4, res = 300)
bias_plot_WD
dev.off()

png(filename = "fig_quadImbMSOR_Bias_WR.png", units = "in",
    width = 6, height = 4, res = 300)
bias_plot_WR
dev.off()
...
#––– quad_imb_msor: Relative Efficiency Plot for Win Difference (RE_WD) –––
...
png(filename = "fig_quadImbMSOR_RE_WD.png", units = "in", width = 6, height = 4, res = 300)
re_plot_WD
dev.off()

ggsave("fig_quadImbMSOR_RE_WD.eps", plot = re_plot_WD, device = "eps", width = 6, height = 4)


#––– quad_imb_msor: Relative Efficiency Plot for Win Ratio (RE_WR) –––
...
png(filename = "fig_quadImbMSOR_RE_WR.png", units = "in", width = 6, height = 4, res = 300)
re_plot_WR
dev.off()

ggsave("fig_quadImbMSOR_RE_WR.eps", plot = re_plot_WR, device = "eps", width = 6, height = 4)
