...
step_size <- 60
re_count <- 10
#setwd("/Users/sizhezuo/Desktop/YCASResearch/WR_Cluster/ClusterSimExpanded/results_quad/results_0224")
...
png(filename = "fig_quad_Var_WD.png", units = "in",
    width = 6, height = 4, res = 300)
var_plot_WD
dev.off()

png(filename = "fig_quad_Var_WR.png", units = "in",
    width = 6, height = 4, res = 300)
var_plot_WR
dev.off()
...
png(filename = "fig_quad_MSE_WD.png", units = "in",
    width = 6, height = 4, res = 300)
mse_plot_WD
dev.off()

png(filename = "fig_quad_MSE_WR.png", units = "in",
    width = 6, height = 4, res = 300)
mse_plot_WR
dev.off()
...
png(filename = "fig_quad_Bias_WD.png", units = "in",
    width = 6, height = 4, res = 300)
bias_plot_WD
dev.off()

png(filename = "fig_quad_Bias_WR.png", units = "in",
    width = 6, height = 4, res = 300)
bias_plot_WR
dev.off()
