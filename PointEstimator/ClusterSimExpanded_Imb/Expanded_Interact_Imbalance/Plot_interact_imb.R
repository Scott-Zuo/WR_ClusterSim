...
#––– interact_imb: Relative Efficiency Plot for Win Difference (RE_WD) –––
...
png(filename = "fig_interactImb_RE_WD.png", units = "in", width = 6, height = 4, res = 300)
re_plot_WD
dev.off()
...
#––– interact_imb: Relative Efficiency Plot for Win Ratio (RE_WR) –––
...
png(filename = "fig_interactImb_RE_WR.png", units = "in", width = 6, height = 4, res = 300)
re_plot_WR
dev.off()
