...
step_size <- scenarios$step_size
re_count <- scenarios$re_count
#setwd("/Users/sizhezuo/Desktop/YCASResearch/WR_Cluster/ClusterSimExpanded/results_interact")
...
png(filename = "fig_interact_Var_WD.png", units = "in",
    width = 6, height = 4, res = 300)
var_plot_WD
dev.off()

png(filename = "fig_interact_Var_WR.png", units = "in",
    width = 6, height = 4, res = 300)
var_plot_WR
dev.off()
...
png(filename = "fig_interact_MSE_WD.png", units = "in",
    width = 6, height = 4, res = 300)
mse_plot_WD
dev.off()

png(filename = "fig_interact_MSE_WR.png", units = "in",
    width = 6, height = 4, res = 300)
mse_plot_WR
dev.off()
...
bias_plot_WD <- ggplot(sim_df_WD, aes(x = samplesize, y = bias,
                                      color = estimator)) + 
  geom_point() + 
  geom_line(aes(group = estimator)) +
  scale_color_manual(values = c("unadjusted" = "black", "IPW" = "gold",
...
bias_plot_WR <- ggplot(sim_df_WR, aes(x = samplesize, y = bias,
                                      color = estimator)) + 
  geom_point() + 
  geom_line(aes(group = estimator)) +
  scale_color_manual(values = c("unadjusted" = "black", "IPW" = "gold",
...
png(filename = "fig_interact_Bias_WD.png", units = "in",
    width = 6, height = 4, res = 300)
bias_plot_WD
dev.off()

png(filename = "fig_interact_Bias_WR.png", units = "in",
    width = 6, height = 4, res = 300)
bias_plot_WR
dev.off()
...
png(filename = "fig_interact_RE_WD.png", units = "in",
    width = 6, height = 4, res = 300)
re_plot_WD
dev.off()

png(filename = "fig_interact_RE_WR.png", units = "in",
    width = 6, height = 4, res = 300)
re_plot_WR
dev.off()
